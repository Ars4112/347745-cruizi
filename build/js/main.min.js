...
var menuMobile = header.querySelector('.menu-mobile');
var buttonOpened = headerNav.querySelector('.nav__button');
var buttonCloced = menuMobile.querySelector('.menu-mobile__button');
var menuMobileNav = menuMobile.querySelector('.menu-mobile__nav');
...
if (viewport <= 768) {
  ...
  [buttonOpened, buttonCloced].forEach(function (elem) {
...
var addValid = function addValid() {
  ...
  var regExpName = /^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$/;
  var isValidate;
  ...
  input.forEach(function (element) {
    ['input', 'blur', 'focus'].forEach(function (elem) {
  ...
  form.addEventListener('submit', function (evt) {
    input.forEach(function (element) {
      ...
      if (element.name === 'tel') {
        if (element.value === '') {
          element.nextElementSibling.textContent = 'Введите номер телефона';
          isValidate = false;
        } else {
          element.nextElementSibling.textContent = '';
        }
...
var addScroll = function addScroll() {
  ...
  var idList = document.querySelectorAll('#benefits, #travaling, #catalog, #contacts');
